...
<ul class="guide-list">
  ...
  <li><strong>VIP Friendly (2-й дзвінок)</strong> — бальна рубрика до 57,5 бала; окрема сторінка в сайдбарі.</li>
  <li><strong>Слив клієнта</strong> — спроба клієнта достроково завершити розмову; критерій утримання контакту (Короткий).</li>
  <li><strong>Критична помилка (сливу)</strong> — порушення з гайду зі сливом, яке обнуляє весь короткий дзвінок (0/30).</li>
